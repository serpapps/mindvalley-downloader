...
- :new: Latest release: [GitHub Releases](https://github.com/serpapps/mindvalley-downloader/releases/latest)
- :question: Help center: [SERP Help](https://help.serp.co/en/)
- :beetle: Report bugs: [GitHub Issues](https://github.com/serpapps/mindvalley-downloader/issues)
- :bulb: Request features: [Feature Requests](https://github.com/serpapps/mindvalley-downloader/issues)
...
- [Why Mindvalley Downloader](#why-mindvalley-downloader)
- [Features](#features)
- [How It Works](#how-it-works)
- [Step-by-Step Tutorial: How to Download Videos from Mindvalley](#step-by-step-tutorial-how-to-download-videos-from-mindvalley)
...
- [FAQ](#faq)
- [Notes](#notes)
- [About Mindvalley](#about-mindvalley)
...
2. Open Mindvalley and navigate to a lesson, quest, or masterclass page.
...
1. Install Mindvalley Downloader from the latest GitHub release.
2. Sign in to Mindvalley and open the lesson page you want to save.
3. Let the page load fully and press play on the video.
4. Click the extension button in your browser toolbar.
5. Review the stream or embedded video options detected for that lesson.
6. Select the quality you want to keep.
7. Start the download and wait for the MP4 export to complete.
8. Open the saved file from your Downloads folder for offline viewing.
...
Start here: [https://serp.ly/mindvalley-downloader](https://serp.ly/mindvalley-downloader)

## Installation Instructions

1. Open the latest release page:
   [https://github.com/serpapps/mindvalley-downloader/releases/latest](https://github.com/serpapps/mindvalley-downloader/releases/latest)
2. Download the extension build for your browser.
3. Install the extension.
4. Open Mindvalley and navigate to a lesson, quest, or masterclass page.
